                ...
                <div className={css.blocks}>
                    ...
                    <div className={css.contacts}>
                                ...
                                .map((x, i) => {
                                        return (
                                            <div key={i} className={css.blockItem}>
                                                <img className={css.svgIcon} src={telephoneIcon} alt={telephoneIcon}/>
                                                <span>{x}</span>
                                            </div>
                                        );
                                    }
                        ...
                        <div className={css.blockItem}>
                            <img className={css.svgIcon} src={emailIcon} alt={emailIcon}/>
                            ...
                            <div>
                                <a href={info.telegramUrl}
                                   ...
                                   target="_blank" rel="noopener noreferrer">
                                    <img className={css.svgIcon} src={instagramIcon} alt={instagramIcon}/>
                                    <span>Instagram</span>
                                </a>
                            </div>
                            <div>
                                <a href={info.telegramUrl}
                                   className={css.blockItem}
                                   target="_blank" rel="noopener noreferrer">
                                    <img className={css.svgIcon} src={telegramIcon} alt={telegramIcon}/>
                                    <span>Telegram</span>
                                </a>
                            </div>
                            <div>
                                <a href={info.telegramUrl}
                                   className={css.blockItem}
                                   target="_blank" rel="noopener noreferrer">
                                    <img className={css.svgIcon} src={whatsappIcon} alt={whatsappIcon}/>
                                    <span>Whatsapp</span>
                                </a>
                            </div>
                        </div>
