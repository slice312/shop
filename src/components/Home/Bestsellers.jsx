...
import {pushCardsBestsellers, cardsBestSellersReset} from "src/shared/state/products/actions";
...
export const Bestsellers = () => {
    const bestsellerCards = useSelector(state => state.products.bestsellers);
